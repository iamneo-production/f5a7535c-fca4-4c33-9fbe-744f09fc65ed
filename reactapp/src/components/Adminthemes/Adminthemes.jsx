...
<br></br>    
<div class="h4 mb-5 rounded-3 text-light">Add Theme</div>
<div class="input-group   mb-5">
  <input type="text" class="form-control" id="enterThemeName" placeholder="enter the theme name"></input>
</div>

<div class="input-group   mb-5">
  <input type="text" class="form-control" id="enterThemePrice" placeholder="enter theme price"></input>
</div>

<div class="input-group   mb-5">
  <input type="text" class="form-control" id="enterThemeDescription" placeholder="enter the description"></input>
</div>

<button type="button" class="btn btn-primary rounded-3" id="add">Add</button>
<br></br>
<br></br>
</div>
